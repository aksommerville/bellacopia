...
const struct battle_type battle_type_regex={//TODO I still don't know what this should be about. Definitely not a full programmer-vs-programmer regex contest. Something light for the masses.
  .name="regex",
  .strix_name=51,
  .no_article=0,
  .no_contest=0,
